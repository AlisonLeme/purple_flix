    ...
    return (
        <>
            ...
            <Box className={styles.thumbsContainer}>
                <Box className={styles.dropzone} {...getRootProps()} style={{display: files.length > 0 && 'none'}}>
                    <input name='files' {...getInputProps()}/>
                    <Typography className={styles.thumbsMsg} variant='body2' color={errors && touched ? 'error' : 'primary'} >
